...
export const translations = {
  en: {
    ...
    tracking_current: "Current position",
    tracking_destination: "Destination",
    tracking_last_position: "Last package position",
    tracking_date: "Date",
    tracking_location: "Location",
    tracking_status: "Status",
    tracking_estimated_arrival: "Estimated arrival",
    tracking_route: "Shipment route",
    tracking_history: "Shipment history",
    tracking_created: "Created",
    tracking_no_events: "No tracking events available yet.",
    tracking_map_hint: "Click a point to view its details. You can zoom and move the map.",
    tracking_remarks: "Remarks",
    tracking_packages: "Packages",
    tracking_product: "Product / package",
    tracking_quantity: "Product quantity",
    tracking_weight: "Weight",
    tracking_mode: "Shipment mode",
    tracking_payment: "Payment mode",
    tracking_total_freight: "Total freight",
    tracking_shipment_date: "Shipment date and time",
    tracking_expected_date: "Expected delivery date",
    admin_panel: "Administration panel",
    admin_shipments: "Shipment management",
    admin_new_shipment: "New shipment",
    admin_logout: "Log out",
    admin_search: "Search by tracking number or customer...",
    admin_total: "Total shipments",
    admin_in_transit: "In transit / flight",
    admin_delivered: "Successfully delivered",
    admin_pending: "Pending",
    admin_create_title: "New shipment",
    admin_recipient: "Recipient information",
    admin_sender: "Sender information",
    admin_freight: "Freight and transport",
    admin_all_statuses: "All statuses",
    admin_filter_status: "Filter by status",
    admin_tracking_no: "Tracking No.",
    admin_route: "Route",
    ...
    admin_global_status: "Global status",
    admin_location: "Location (Hub / City / Port)",
    admin_status_title: "Status title",
    admin_description: "Detailed description",
    admin_cancel: "Cancel",
    admin_save_step: "Save step",
    admin_verify: "Verifying...",
  ...
  fr: {
    ...
    tracking_origin: "Origine",
    tracking_current: "Position actuelle",
    tracking_destination: "Destination",
    tracking_last_position: "Dernière position du colis",
    tracking_date: "Date",
    tracking_location: "Lieu",
    tracking_status: "Statut",
    tracking_estimated_arrival: "Arrivée estimée",
    tracking_route: "Trajet de l'expédition",
    tracking_history: "Historique d'acheminement",
    tracking_created: "Création",
    tracking_no_events: "Aucun événement de suivi disponible pour le moment.",
    tracking_map_hint: "Cliquez sur un point pour voir ses détails. Vous pouvez zoomer et déplacer la carte.",
    tracking_remarks: "Remarques",
    tracking_packages: "Colis",
    tracking_product: "Produit / colis",
    tracking_quantity: "Quantité du produit",
    tracking_weight: "Poids",
    tracking_mode: "Mode de transport",
    tracking_payment: "Mode de paiement",
    tracking_total_freight: "Fret total",
    tracking_shipment_date: "Date et heure d'expédition",
    tracking_expected_date: "Date de livraison estimée",
    admin_panel: "Panneau d'administration",
    admin_shipments: "Gestion des expéditions",
    admin_new_shipment: "Nouvelle expédition",
    admin_logout: "Déconnexion",
    admin_search: "Rechercher par numéro de suivi ou client...",
    admin_total: "Total expéditions",
    admin_in_transit: "En transit / vol",
    admin_delivered: "Livrées avec succès",
    admin_pending: "En attente",
    admin_create_title: "Nouvelle expédition",
    admin_recipient: "Informations du destinataire",
    admin_sender: "Informations de l'expéditeur",
    admin_freight: "Fret et transport",
    admin_all_statuses: "Tous les statuts",
    admin_filter_status: "Filtrer par statut",
    admin_tracking_no: "N° de suivi",
    admin_route: "Itinéraire",
    admin_service: "Service",
    admin_status: "Statut",
    admin_actions: "Actions",
    admin_update: "Mettre à jour",
    admin_add_event: "Ajouter un événement",
    admin_global_status: "Nouveau statut global",
    admin_location: "Localisation (Hub / Ville / Port)",
    admin_status_title: "Titre du statut",
    admin_description: "Description détaillée",
    admin_cancel: "Annuler",
    admin_save_step: "Enregistrer l'étape",
    admin_verify: "Vérification...",
